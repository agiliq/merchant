...
class AmazonFPSTestCase(TestCase):
    ...
    def testLinkGen(self):
        ...
        pregen_link = """<a href="https://authorize.payments-sandbox.amazon.com/cobranded-ui/actions/start?callerKey=%(aws_access_key)s&callerReference=100&paymentPage=&paymentReason=Digital%%20Download&pipelineName=SingleUse&returnURL=http%%3A%%2F%%2Flocalhost%%2Ffps%%2Ffps-return-url%%2F&returnURLPrefix=http%%3A%%2F%%2Flocalhost&signature=loMkZGPTiZlcNRfYHa00nHREedPMaoiHZt%%2FNCA8e5Ko%%3D&signatureMethod=HmacSHA256&signatureVersion=2&transactionAmount=30"><img src="http://g-ecx.images-amazon.com/images/G/01/cba/b/p3.gif" alt="Amazon Payments" /></a>""" %({"aws_access_key": settings.AWS_ACCESS_KEY})
